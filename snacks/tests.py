...
class SnackTests(TestCase):
    def setUp(self):
        ...
        self.snack = Snack.objects.create(
            name="test snack", description='This is a test description.', purchaser=self.user,
        )
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(self.snack.description, 'This is a test description.')
    ...
    def test_snack_create_view(self):
        ...
        self.assertContains(response, "Description: My second description")
